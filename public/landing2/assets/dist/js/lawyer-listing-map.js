initialize = (function(){
  var info = '<div class="map-marker-custom">' +
    '<div class="marker-img"> <img src="../assets/dist/img/lawyer/map-info.jpg" alt=""/></div>'+
    '<div class="marker-info">'+
    '<h4>Cathleen Moran</h4>'+
    ...
    '</div>'+
    '<p class="rq-listing-item-address"><i class="icon_pin"></i>Sanfrancisco, CA</p>'+
    '<div>'+
    '</div>';
  ...
  for (i = 0; i < locations.length; i++) {
    marker = new google.maps.Marker({
      ...
      icon: '../assets/dist/img/lawyer/listing-plain-heading/map/icon-'+(i%6)+'.png' ,
      map: map,
