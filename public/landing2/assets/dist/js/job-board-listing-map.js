initialize = (function(){
  var info = '<div class="map-marker-custom">' +
    '<div class="marker-img"> <img src="../assets/dist/img/job-board/map-info.jpg" alt=""/></div>'+
    '<div class="marker-info">'+
    '<h4>evin softwaretech inc</h4>'+

    '<p class="rq-listing-item-address">96 Moutain Ave St, Ny</p>'+

    '<div class="rq-address-text">Field: Society, Community</div>'+
    '<div>'+
    '</div>';
  ...
  for (i = 0; i < locations.length; i++) {
    marker = new google.maps.Marker({
      ...
      icon: '../assets/dist/img/job-board/listing-plain-heading/map/icon-'+(i%6)+'.png' ,
      map: map,
