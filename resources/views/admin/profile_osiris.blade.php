...
<div class="row">
    <div class="card">
        <div class="card-content">
            <h3>Profile osiris</h3>
            <div class="divider"></div>
            <br>
            @foreach($about as $p)
            <h4 class="card-title">Judul</h4>
            <form enctype="multipart/form-data" method="post" action="{{ route('profile_osiris.update', $p->id) }}" class="m-t-40">
                @method('PATCH')
                @csrf
                ...
                <br>
                <h4 class="card-title">Instagram Osiris</h4>
                <div class="input-field col s12">
