            ...
            <ul id="slide-out" class="sidenav">
                ...
                <li>
                    <ul class="collapsible">
                        ...
                        <li>
                            <a href="{{ url('about')}}" class="collapsible-header"><i class="material-icons">library_books</i><span class="hide-menu"> Profil Antasena</span></a>
                        </li>
                        <!-- <li>
                        ...
                        <li>
                            <a href="{{ url('partner')}}" class="collapsible-header"><i class="material-icons">rate_review</i><span class="hide-menu">Partner</span></a>
                        </li>

                         <li>
                            <a href="{{ url('profile_isc')}}" class="collapsible-header"><i class="material-icons">perm_identity</i><span class="hide-menu">Profile ISC</span></a>
                        </li>  
                        <li>
                            <a href="{{ url('isc')}}" class="collapsible-header"><i class="material-icons">announcement</i><span> Lomba ISC</span></a>
                        </li>
                        <li>
                            <a href="{{ url('profile_fiqsi')}}" class="collapsible-header"><i class="material-icons">perm_identity</i><span class="hide-menu">Profile Fiqsi</span></a>
                        </li>
                        <li>
                            <a href="{{ url('fiqsi')}}" class="collapsible-header"><i class="material-icons">notification_important</i><span> Lomba FIQSI</span></a>
                        </li>
                        <li>
                            <a href="{{ url('profile_osiris')}}" class="collapsible-header"><i class="material-icons">perm_identity</i><span class="hide-menu">Profile Osiris</span></a>
                        </li>
                        <li>
                            <a href="{{ url('osiris')}}" class="collapsible-header"><i class="material-icons">view_agenda</i><span> Lomba OSIRIS</span></a>
                        </li>
                        <li>
